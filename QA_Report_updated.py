...
csv_file = output_dir + '_' + date + "_results.csv"
...
# 4.2.2 Map
figure1_direction = output_dir + '_map1.pdf'
...
# 4.2.3 Plot1
figure2_direction = output_dir + '_plot2.pdf'
...
axes[2].plot(norm_x, norm_y, 'r-', label='Normal Distribution Fit')
axes[2].set_xlabel("Signal intensity")
axes[2].set_ylabel("Probability Density")
axes[2].set_title('Distribution of the Signal Fluctuation')
axes[2].legend()
...
# 4.2.4 Plot2
figure3_direction = output_dir + '_plot3.pdf'
fig, axes = plt.subplots(2,figsize=(10, 16))
# Fluctuation Frequency Spectrum
axes[0].plot(freq,spec)
axes[0].set_xlabel("Frequency (Hz)")
axes[0].set_ylabel("Magnitude")
axes[0].set_title('Fluctuation Frequency Spectrum')
axes[0].grid(True, linestyle='--')
# Coefficient of Variant
roi_list = range(1,roi_width+1)
axes[1].plot(roi_list,CV*100,linewidth=1,marker='.',markersize=10,color='b',label='Measured')
axes[1].plot(roi_list,CV_ideal*100,linewidth=1,marker='.',markersize=10,color='r',label='Theoretical')
axes[1].set_xlabel("ln(ROI width pixels)")
axes[1].set_ylabel("ln(100*CV)")
axes[1].set_title('Coefficient of Variant')
axes[1].legend()
axes[1].set_yscale('log')
axes[1].set_xscale('log')
axes[1].grid(True, linestyle='--')
plt.savefig(figure3_direction)
plt.close()

# 4.2.5 Plot3
figure4_direction = output_dir + '_plot4.pdf'
fig, axes = plt.subplots(2,figsize=(10, 16))
# Ghost Rate Time-Series
axes[0].plot(ghost_rate_t,color='b')
axes[0].set_xlabel("Volume Number")
axes[0].set_ylabel("Ghost Rate (%)")
axes[0].set_title('Ghost Rate Time-Series')
axes[0].grid(True, linestyle='--')
# Background Intensity Time-Series
axes[1].plot(background_t,color='b')
axes[1].set_xlabel("Volume Number")
axes[1].set_ylabel("Background Intensity")
axes[1].set_title('Background Intensity Time-Series')
axes[1].grid(True, linestyle='--')
plt.savefig(figure4_direction)
plt.close()

# 4.2.6 Merge
output_direction = output_dir + '_' + date + '_Report.pdf'
pdf_files = [text_direction, figure1_direction, figure2_direction, figure3_direction, figure4_direction]
merger = PdfMerger()
